...
[![pre-commit.ci status](https://results.pre-commit.ci/badge/github/hsf-training/hsf-training-llms-for-hep/main.svg)](https://results.pre-commit.ci/latest/github/hsf-training/hsf-training-llms-for-hep/main)
[![deploy-book](https://github.com/hsf-training/hsf-training-llms-for-hep/actions/workflows/deploy.yml/badge.svg)](https://github.com/hsf-training/hsf-training-llms-for-hep/actions/workflows/deploy.yml)

# Large Language Models for HEP and Nuclear Physics

> **Note**
> Click [here](https://hsf-training.github.io/hsf-training-llms-for-hep/) for the training website!


An introduction to Large Language Models (LLMs) and its application on software development for HEP and Nuclear Physics
